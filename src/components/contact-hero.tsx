...
// Weight contrast + italic accent — same technique as the main Hero
const headingLines = [
    { words: ["Peça", "o", "seu"], weight: "font-normal", italic: false, teal: false },
    { words: ["Orçamento."],       weight: "font-bold",   italic: true,  teal: true  },
];
...
export function ContactHero() {
    ...
    return (
        <section className="relative overflow-hidden pt-32 pb-20">
            {/* Background — same dark teal gradient as all dark sections */}
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                        ...
                        >
                            {line.words.map((word, wordIdx) => (
                                <Fragment key={`${lineIdx}-${wordIdx}`}>
                                    ...
                                    {/* Word space lives outside the clip */}
                ...
                >
                    Preencha o formulário ou contacte-nos directamente.
